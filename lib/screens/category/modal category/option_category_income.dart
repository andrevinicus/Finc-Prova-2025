                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      border: OutlineInputBorder(
                        // Bordas arredondadas para o TextField
                  ...
                  if (state is GetCategoriesLoading) {
                    ...
                    final categories = state.categories
                        .where((category) =>
                            ...
                            category.type == 'income') // Filtra por 'income'
                        .toList()
                              ...
                              ListTile(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          color: categoryColor,
                                          // As categorias já usam BoxShape.circle para serem redondas
                                ...
                                trailing: selectedCategory == category
                                    ...
                                    : Container(
                                        ...
                                        height: 15,
                                        decoration: BoxDecoration(
                                          // O círculo de seleção/não seleção também é arredondado
                                          shape: BoxShape.circle,
                                          border: Border.all(
